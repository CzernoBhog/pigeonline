...
<body class="">
    <span class="preheader">PigeOnLine</span>
            ...
            <td class="container">
                <div class="content">
                    ...
                    <table role="presentation" class="main">
                        ...
                        <tr height='80'>
                            <td colspan='4' align='center' style='background-color:lightblue; border-top:dashed #00a2d1 2px; font-size:24px; '>
                                <label>PigeOnLine On :
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td class="content-block powered-by">
                                    Powered by <a href="http://localhost:8080/esercizi/pigeonline/">PigeOnline</a>.
                                </td>
                            </tr>
                        </table>
                    </div>
